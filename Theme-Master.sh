#Coded By RED-MAFIA @Sl cyber warriors
...
echo -e "\e[1;39m   ╚═╝     ╚═╝╚═╝  ╚═╝╚══════╝   ╚═╝   ╚══════╝╚═╝  ╚═╝"
echo
echo -e "\e[1;39m\e[44m      Coded By RED-MAFIAOwner of Sl Cyber Warriors)     "
echo -e "\e[49m "
}
tool(){
logo
...
cd
rm -rf Theme-Master
git clone http://github.com/Red-Mafia/Theme-Master.git
cd Theme-Master
bash Theme-Master.sh
...
logo
echo
echo -e '\e[1;33m        Coded By RED-MAFIA ᶜʸᴮᴱᴿ ᵂᴬᴿᴿᴵᴼᴿ'
echo
echo -e '        By Sl Cyber Warriors (A Technical channell )'
echo
echo -e '        By:'
echo -e '            Red-Mafia ft. John kener'
echo
echo -e '        Join us: '
echo -e '            Watsapp: https://wa.me/+923188214452'
echo
echo -e '\e[1;39m '
echo -e '\e[1;39m\e[44m   RED-MAFIA @Cyber Warriors Dave Smith @Cyber Warriors \e[49m      '
echo
...
if [ "$c" -eq 1 ]
then
xdg-open https://www.facebook.com/ᎡᎬᎠ-ᎷᎪҒᏆᎪ-102896575436747/?ref=share
sleep 5
bash Theme-Master.sh
...
then
xdg-open http://wa.me/+923188214452
sleep 5
bash Theme-Master.sh
